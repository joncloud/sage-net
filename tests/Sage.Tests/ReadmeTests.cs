...
namespace Sage.Tests
{
    ...
    {
        readonly CsprojFixture _csprojFixture;
        readonly ReadmeFixture _readmeFixture;
        public ReadmeTests(CsprojFixture csprojFixture, ReadmeFixture readmeFixture)
        {
            _csprojFixture = csprojFixture;
        ...
        {
            var versionPrefixElement = _csprojFixture.Document
                .Root
